...
public class Kugou
{
    private readonly KugouMusicLyricRule _rule = new();
    ...
    public void FindWindow()
    {
        ...
        Assert.That(window.WindowName, Is.EqualTo("桌面歌词 - 酷狗音乐"));
    }
    ...
    public void ObsName()
    {
        Assert.That(_rule.ObsWindowName, Is.EqualTo("[KuGou.exe]: 桌面歌词 - 酷狗音乐"));
    }
}